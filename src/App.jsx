        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="text-center">
                <img src="/phoenix arizona.jpg" alt="Phoenix, Arizona" className="rounded-lg mb-4 w-full h-48 object-cover" />
                <p className="text-sm text-gray-500">Downtown Phoenix, Arizona</p>
              </div>
              <div className="text-center">
                <img src="/philadelphia pa.jpg" alt="Philadelphia, Pennsylvania" className="rounded-lg mb-4 w-full h-48 object-cover" />
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Card>
              <CardContent className="pt-6">
                <form action="https://formspree.io/f/manjegwz" method="POST" className="space-y-4">
